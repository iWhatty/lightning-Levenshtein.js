...
export function lev_3x2(a, b, ai = 0, bi = 0) {
  const a0 = a.charCodeAt(ai), a1 = a.charCodeAt(ai + 1), a2 = a.charCodeAt(ai + 2);
  const b0 = b.charCodeAt(bi), b1 = b.charCodeAt(bi + 1);
...
export function lev_3x3(a, b, ai = 0, bi = 0) {
  const a0 = a.charCodeAt(ai), a1 = a.charCodeAt(ai + 1), a2 = a.charCodeAt(ai + 2);
  const b0 = b.charCodeAt(bi), b1 = b.charCodeAt(bi + 1), b2 = b.charCodeAt(bi + 2);
...
export function lev_4x4(a, b, ai = 0, bi = 0) {
  const a0 = a.charCodeAt(ai), a1 = a.charCodeAt(ai + 1), a2 = a.charCodeAt(ai + 2), a3 = a.charCodeAt(ai + 3);
  const b0 = b.charCodeAt(bi), b1 = b.charCodeAt(bi + 1), b2 = b.charCodeAt(bi + 2), b3 = b.charCodeAt(bi + 3);
...
export function lev_4x3(a, b, ai = 0, bi = 0) {
  const a0 = a.charCodeAt(ai), a1 = a.charCodeAt(ai + 1), a2 = a.charCodeAt(ai + 2), a3 = a.charCodeAt(ai + 3);
  const b0 = b.charCodeAt(bi), b1 = b.charCodeAt(bi + 1), b2 = b.charCodeAt(bi + 2);
...
export function lev_4x2(a, b, ai = 0, bi = 0) {
  const a0 = a.charCodeAt(ai), a1 = a.charCodeAt(ai + 1), a2 = a.charCodeAt(ai + 2), a3 = a.charCodeAt(ai + 3);
  const b0 = b.charCodeAt(bi), b1 = b.charCodeAt(bi + 1);
...
export function lev_4x1(a, b, ai = 0, bi = 0) {
  const b0 = b.charCodeAt(bi);
  return (
    a.charCodeAt(ai) === b0 ||
    a.charCodeAt(ai + 1) === b0 ||
    a.charCodeAt(ai + 2) === b0 ||
    a.charCodeAt(ai + 3) === b0
  ) ? 3 : 4;
}